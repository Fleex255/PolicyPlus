...
namespace PolicyPlus.UI
{
    public partial class DetailPolicy
    {
        ...
        private void SupportButton_Click(object sender, EventArgs e) => MyProject.Forms.DetailSupport.PresentDialog(_selectedPolicy.SupportedOn);

        private void CategoryButton_Click(object sender, EventArgs e) => MyProject.Forms.DetailCategory.PresentDialog(_selectedPolicy.Category);
    }
}