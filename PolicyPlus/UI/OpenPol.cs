...
namespace PolicyPlus.UI
{
    public partial class OpenPol
    {
        ...
        private void UserBrowseRegistryButton_Click(object sender, EventArgs e)
        {
            ...
            if (MyProject.Forms.OpenUserRegistry.ShowDialog() == DialogResult.OK)
            {
                UserHivePathTextbox.Text = MyProject.Forms.OpenUserRegistry.SelectedFilePath;
            }
        }
        ...
        private void UserBrowseGpoButton_Click(object sender, EventArgs e)
        {
            ...
            if (MyProject.Forms.OpenUserGpo.ShowDialog() == DialogResult.OK)
            {
                UserGpoSidTextbox.Text = MyProject.Forms.OpenUserGpo.SelectedSid;
            }
        }
