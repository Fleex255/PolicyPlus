...
namespace PolicyPlus.UI
{
    public partial class DetailAdmx
    {
        ...
        private void LsvPolicies_DoubleClick(object sender, EventArgs e) => MyProject.Forms.DetailPolicy.PresentDialog((PolicyPlusPolicy)LsvPolicies.SelectedItems[0].Tag);

        private void LsvCategories_DoubleClick(object sender, EventArgs e) => MyProject.Forms.DetailCategory.PresentDialog((PolicyPlusCategory)LsvCategories.SelectedItems[0].Tag);

        private void LsvProducts_DoubleClick(object sender, EventArgs e) => MyProject.Forms.DetailProduct.PresentDialog((PolicyPlusProduct)LsvProducts.SelectedItems[0].Tag);

        private void LsvSupportDefinitions_DoubleClick(object sender, EventArgs e) => MyProject.Forms.DetailSupport.PresentDialog((PolicyPlusSupport)LsvSupportDefinitions.SelectedItems[0].Tag);
    }
}