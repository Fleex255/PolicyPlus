                        ...
                        case "decimalTextBox":
                            {
                                ...
                                {
                                    DefaultValue = Conversions.ToUInteger(uiElement.AttributeOrDefault("defaultValue", 1)),
                                    HasSpinner = Conversions.ToBoolean(uiElement.AttributeOrDefault("spin", true)),
                                    SpinnerIncrement = Conversions.ToUInteger(uiElement.AttributeOrDefault("spinStep", 1)),
                        ...
                        case "checkBox":
                            {
                                ...
                                {
                                    DefaultState = Conversions.ToBoolean(uiElement.AttributeOrDefault("defaultChecked", false)),
                                    Text = uiElement.InnerText
                                };
                                break;
                            }
                        case "comboBox":
                            {
                                ...
                                {
                                    NoSort = Conversions.ToBoolean(uiElement.AttributeOrDefault("noSort", false))
                                };
                        ...
                        case "dropdownList":
                            {
                                ...
                                {
                                    NoSort = Conversions.ToBoolean(uiElement.AttributeOrDefault("noSort", false)),
                                    DefaultItemId = Conversions.ToInteger(uiElement.AttributeOrNull("defaultItem")),
                                    Label = uiElement.InnerText
                                };
                                break;
                            }
