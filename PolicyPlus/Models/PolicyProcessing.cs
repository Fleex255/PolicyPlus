                    ...
                    case "list":
                        {
                            ...
                            {
                                var entries = policySource.GetValueNames(elemKey).ToDictionary(value => value, value => Conversions.ToString(policySource.GetValue(elemKey, value)));
                            ...
                            foreach (var elem in rawpol.Elements)
                            {
                                ...
                                switch (elem.ElementType ?? "")
                                {
                                    ...
                                    case "boolean":
                                        {
                                            var booleanElem = (BooleanPolicyElement)elem;
                                            var checkState = Conversions.ToBoolean(optionData);
