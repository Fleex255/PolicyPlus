                                                        ...
                                                        case "decimal":
                                                            {
                                                                ...
                                                                {
                                                                    Minimum = Conversions.ToUInteger(uiElement.AttributeOrDefault("minValue", 0)),
                                                                    Maximum = Conversions.ToUInteger(uiElement.AttributeOrDefault("maxValue", uint.MaxValue)),
                                                                    NoOverwrite = Conversions.ToBoolean(uiElement.AttributeOrDefault("soft", false)),
                                                                    StoreAsText = Conversions.ToBoolean(uiElement.AttributeOrDefault("storeAsText", false))
                                                                };
                                                                break;
                                                            }
                                                        case "boolean":
                                                        ...
                                                        case "text":
                                                            {
                                                                ...
                                                                {
                                                                    MaxLength = Conversions.ToInteger(uiElement.AttributeOrDefault("maxLength", 255)),
                                                                    Required = Conversions.ToBoolean(uiElement.AttributeOrDefault("required", false)),
                                                                    RegExpandSz = Conversions.ToBoolean(uiElement.AttributeOrDefault("expandable", false)),
                                                                    NoOverwrite = Conversions.ToBoolean(uiElement.AttributeOrDefault("soft", false))
                                                                };
                                                                break;
                                                            }
                                                        case "list":
                                                            {
                                                                ...
                                                                {
                                                                    NoPurgeOthers = Conversions.ToBoolean(uiElement.AttributeOrDefault("additive", false)),
                                                                    RegExpandSz = Conversions.ToBoolean(uiElement.AttributeOrDefault("expandable", false)),
                                                                    UserProvidesNames = Conversions.ToBoolean(uiElement.AttributeOrDefault("explicitValue", false)),
